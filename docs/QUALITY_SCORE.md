...
| Test framework           | C     | Catch2 v3 buckets green for `oran-core` (54 cases / 366 assertions), `oran-async` (8 cases / 38 assertions), `oran-io` (8 cases / 33 assertions), `oran-storage` (52 cases / 606 assertions), `oran-config` (14 cases / 132 assertions), `oran-permission` (41 cases / 165 assertions), `oran-cli` (5 cases / 30 assertions), and `oran-bootstrap` (8 cases / 34 assertions). | Add first tool / hook tests when those libraries land. |
