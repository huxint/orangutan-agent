...
| Automation job prompts / trigger payloads | [`../product-specs/0006-automation.md`](../product-specs/0006-automation.md), [`../design-docs/automation-runtime.md`](../design-docs/automation-runtime.md) | Stored cron/triggered `agent_prompt` text, optional triggered payload framing, and the bootstrap automation prompt bridge. These bytes enter the dynamic user turn, not cached sections (1)-(6). |
