...
without choosing concrete cli/channel/desktop routing. Detached process timers,
queueing, concrete notifier routing, queue hold/drop policy for blocked agent
leases, triggered queue/backpressure/draining, and agent firing remain
downstream.
...
conflicts, while richer blocked-agent hold/requeue policy remains downstream.
