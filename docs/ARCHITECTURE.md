...
Automation retention ownership note: slice 197 keeps automation state explicit
...
finite caller-owned policy over the leased step. Slice 197 adds pure cron schedule evaluation without making bootstrap open or run automation state.
