...
policy for blocked agent leases, triggered execution/run history, and agent
...
intake timestamp in the result. It does not persist trigger events, enqueue
work, notify channels, acquire execution leases, or call agents.
