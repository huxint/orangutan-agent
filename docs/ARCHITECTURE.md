...
ownership into bootstrap. Detached process timers, queueing, notifier routing, queue hold/drop
policy for blocked agent leases, triggered queue/backpressure/draining, and agent firing
remain downstream.
