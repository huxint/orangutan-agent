...
errors as `aborted`, still without changing bootstrap ownership.
...
execution leases for explicit loop owners. Detached process timers,
agent-facing category/agent leases, queueing, notifier routing, and agent
