...
and slice 201 adds finite caller-owned cron loop policy, without making
bootstrap open or run automation state.
...
finite budget without starting a daemon. Cron config ownership, process timers,
