...
> binary path stays on the no-runner shell until real adapters exist; slice 111
...
> profile-routed provider system plus route for runner owners; slice 16
