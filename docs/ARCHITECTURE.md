...
handler execution over that intake path.
...
handler errors. It does not persist a queue, notify channels, acquire triggered
agent leases, or call agents.
