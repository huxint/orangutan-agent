...
long-running loop, or fire agents.
...
applies seeds, and awaits the existing finite cron loop. Detached process
timers, queueing, notifier routing, and agent firing remain downstream.
