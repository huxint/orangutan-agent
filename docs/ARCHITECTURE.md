...
advisory cron lifecycle hook metadata, without making bootstrap open or run
automation state.
...
hook metadata around handler execution. Cron config ownership, process timers,
queueing, notifier routing, and agent firing remain downstream.
