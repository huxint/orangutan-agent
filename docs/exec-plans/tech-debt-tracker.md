...
| Tool input preparation | Move memory, child and catalogue argument validation onto the prepared-call boundary; their ordinary handlers currently parse after approval. Keep memory scope and child authority in host bindings. | Invalid arguments do not spend approval or invoke services; scoped recall, child policy intersection and catalogue selection still pass through ordinary dispatch. |
