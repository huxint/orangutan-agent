...
| `storage`          | literal `execute` inserts / cold migration apply / direct `Connection` read / fresh prepare | prepared statement binding / no-op migration check / `Pool::acquire_reader` read / cached prepare |
