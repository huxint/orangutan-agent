...
// steps, caller-driven triggered intake/execution with optional triggered agent
// leases, retention/cron/triggered hook metadata, and caller-started leased
// retention loop steps plus finite loop policy. Queue / backpressure policy and
