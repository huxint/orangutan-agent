...
// plus durable cron job state, a caller-owned automation runtime handle, a
// caller-driven retention tick owner with optional retention hook metadata, and
// caller-started leased retention loop steps plus finite loop policy. Triggered
// jobs, queue/backpressure policy, and detached background service loops land
