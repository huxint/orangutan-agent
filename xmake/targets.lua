...
oran_lib("tool", { "oran-core", "oran-async", "oran-io", "oran-permission" }, { "nlohmann_json" })
...
target("orangutan")
    set_kind("binary")
    set_group("oran-bins")
    add_deps("oran-core", "oran-async", "oran-io", "oran-storage", "oran-config", "oran-permission", "oran-tool", "oran-cli", "oran-bootstrap")
